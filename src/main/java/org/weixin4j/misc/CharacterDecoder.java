 ...
 * referenced in the See Also list below. 79 * 80 * @author Chuck McManis 81 *
 * @see CEFormatException 82 * @see CharacterEncoder 83 * @see UCDecoder 84 *
 * @see UUDecoder 85 * @see BASE64Decoder 86
 */
public abstract class CharacterDecoder {
     ...
     * encoded 183 * buffer and returns a byte array containing the data. 184 *
     * @exception CEFormatException An error has occured while decoding 185
     */
